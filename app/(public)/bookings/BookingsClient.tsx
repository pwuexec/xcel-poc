...
function BookingCard({ booking, toUser, fromUser, currentUser, unreadCount, onOpenDialog }: BookingCardProps) {
    ...
    // Can join video call if URL has been generated (cron job does this 10 minutes before)
    const canJoinVideoCall = !!booking.lessonSpaceUrl;
    ...
    const actionButtons: ActionButton[] = [
        {
            ...
            icon: VideoIcon,
            onClick: () => {
                // URL is pre-generated by cron job, just open it
                if (booking.lessonSpaceUrl) {
                    window.open(booking.lessonSpaceUrl, '_blank', 'noopener,noreferrer');
                }
            },
